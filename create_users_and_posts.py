...
def create_users():
    users_data = [
        {"firstname": "Emeka", "lastname": "Emodi", "username": "mex619", "email": "emodiemeka@gmail.com",
         "password": "password"},
        {"firstname": "Olivia", "lastname": "Juma", "username": "sweet_olive100", "email": "olivia@example.com",
         "password": "password"},
        {"firstname": "Mousa", "lastname": "Diop", "username": "mdiop2real", "email": "moussa@example.com",
         "password": "password"},
        {"firstname": "Lerato", "lastname": "Ndlovu", "username": "terra.lera3000", "email": "lerato@example.com",
         "password": "password"},
        {"firstname": "Abdul", "lastname": "Kadir", "username": "gentle_abdul", "email": "abdul@example.com",
         "password": "password"},
        {"firstname": "Mariam", "lastname": "Ejeh", "username": "queen_mariam_d_first", "email": "mariam@example.com",
         "password": "password"},
        {"firstname": "Anna", "lastname": "Schmidt", "username": "pretty-anna10", "email": "anna@example.com",
         "password": "password"},
        {"firstname": "Carlos", "lastname": "Gutierrez", "username": "carlosGstylo", "email": "carlos@example.com",
         "password": "password"},
        {"firstname": "Ikenna", "lastname": "Okafor", "username": "ikemannn808", "email": "ikenna@example.com",
         "password": "password"},
        {"firstname": "Adien", "lastname": "O'Connor", "username": "doc_connor", "email": "aiden@example.com",
         "password": "password"}
    ]

    hashed_passwords = [bcrypt.generate_password_hash(user_data["password"]).decode('utf-8') for user_data in users_data]
    users = [User(firstname=user_data["firstname"], lastname=user_data["lastname"], username=user_data["username"],
...
def create_posts(users):
    ...
    posts = [Post(title=post_data["title"], content=post_data["content"], user_id=post_data["user_id"]) for post_data in posts_data]
    return posts
